...
new_dir = os.path.join('neus2llff_preprocessed', args.exp_name)
...
new_dir = os.path.join(new_dir, 'sparse', '0_raw')

with open(os.path.join(new_dir, 'cameras.txt'), 'w') as f:
...
with open(os.path.join(new_dir, 'points3D.txt'), 'w') as f:
    pass